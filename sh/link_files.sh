...
ln -sf "$dotfiles_dir/apps/vim/coc-settings.json" "$HOME/.config/nvim/coc-settings.json"
ln -sf "$dotfiles_dir/apps/vscode/settings.json" "$HOME/.config/Code/User/settings.json"
